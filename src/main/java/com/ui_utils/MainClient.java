...
public class MainClient {
    ...
    public MainClient(FMLJavaModLoadingContext context) {
    ...
    private void onRegisterKeyMappings(RegisterKeyMappingsEvent event) {
        restoreScreenKey = new KeyMapping("Restore Screen", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_V, KeyMapping.Category.MISC);
        event.register(restoreScreenKey);
    }
    ...
    public static void createText(Minecraft mc, GuiGraphics context, Font textRenderer) {
        ...
        context.drawString(textRenderer, "State Id: " + mc.player.containerMenu.getStateId(), 200, 35, Color.WHITE.getRGB(), false);
    }
    ...
    public static void createWidgets(Minecraft mc, Screen screen) {
            ...
            clickSlotButton.addActionListener((event) -> {
                ...
                sendButton.addActionListener((event0) -> {
                    if (
                        ...
                        ClickType action = MainClient.stringToSlotActionType(actionField.getSelectedItem().toString());
        ...
        fabricatePacketButton.active = !System.getProperty("os.name", "").toLowerCase().contains("mac");
    ...
    public static ClickType stringToSlotActionType(String string) {
        // converts a string to ClickType
